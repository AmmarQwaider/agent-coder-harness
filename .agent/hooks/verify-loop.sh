...
# is configured at .agent/settings.json,
...
cfg="$proj/.agent/settings.json"
[ -f "$cfg" ] || cfg="$proj/.claude/harness-kit.json"
[ -f "$cfg" ] || exit 0
...
msg="agent-coder-harness: changes present — verify before done with: ${rooted_cmd}"
